...
function Students() {
    ...
    const filteredStudents = useMemo(() => {
        ...
        return students.filter((student) =>
            ...
            student.collegeName.toLowerCase().includes(search.toLowerCase())
            ...
            <div className="student-header">
                ...
                <div>
                    ...
                    <p>
                        ...
                        Manage students across all colleges.
                ...
                <button
                    ...
                    onClick={() => navigate("/superadmin/students/create")}
                >
                                    ...
                                    <td>
                                        ...
                                        <div className="student-actions">
                                            ...
                                            <button
                                                className="view-btn"
                                                onClick={() =>
                                                    navigate(`/superadmin/students/view/${student.id}`)
                                                }
                                            >
                                            ...
                                            <button
                                                className="edit-btn"
                                                onClick={() =>
                                                    navigate(`/superadmin/students/edit/${student.id}`)
                                                }
                                            >
